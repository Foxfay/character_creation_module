...
def attack(char_name: str, char_class: str) -> str:
    """Определение урона в заисимости от класса игрока."""
...
def defence(char_name: str, char_class: str) -> str:
    """Опредление защиты в зависимости от клааса игрока."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Опредление заклинание в зависимости от клааса игрока."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Ввод игроком 3 различные команды.
    И в завимиости от того что ввел пользователь, использование 3-х функций.
    """
    if char_class == 'warrior':
